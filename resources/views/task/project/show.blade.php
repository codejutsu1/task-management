    ...
    <div class="mt-8 bg-white dark:bg-gray-800 p-10 overflow-hidden shadow sm:rounded-lg">
        <div class="flex justify-between">
          ...
          <div class="dark:bg-gray-900 p-4">
            ...
            <a href="{{ route('projects.edit', $project->id) }}" class="inline-block dark:bg-zinc-500 mb-5 p-4 rounded-md dark:text-gray-300">
                Create New Task
            </a>
            <ul class="py-4 space-y-8">
                <li class="flex justify-between dark:bg-zinc-400 p-3 rounded-md items-center">
                    <p class="w-3/5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta fugit pariatur repellat libero reiciendis, iusto similique, obcaecati maiores ipsa quas nam omnis autem, enim officiis excepturi laudantium molestiae! Earum, sunt.</p>
                    <span class="flex flex-col items-center">
                        <a href="{{ route('projects.edit', $project->id) }}" class="inline-block dark:bg-green-900 mb-3 p-2 rounded-md dark:text-gray-200">
                            Edit Task
                        </a>
